...
class CourseManager extends Manager {
    static queries = {
        ...
        postCourse: "INSERT INTO courses (title,startdate,enddate,type) VALUES ($1,$2,$3,$4) RETURNING *;", //Array course con course creado
        patchCourse: "UPDATE courses SET title = $1,startDate = $2,endDate = $3,type = $4 WHERE id = $5 RETURNING *", //Array course con course modificado
    ...
    static async postCourses({ title, startdate: startDate, enddate: endDate, type }) {
