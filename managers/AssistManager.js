...
class AssistManager extends Manager {
    static queries = {
        ...
        patchAssist: "UPDATE assistance SET participantid=$1, classid=$2, ispartial=$3, coments=$4, assistance=$5 WHERE id = $6 RETURNING *;", //Array assist con assist modificado
